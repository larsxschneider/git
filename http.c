...
static int keep_invalid_credentials = 1;
...
static int http_options(const char *var, const char *value, void *cb)
{
	...
	if (!strcmp("http.keepinvalidcredentials", var)) {
		keep_invalid_credentials = git_config_bool(var, value);
		return 0;
	}
